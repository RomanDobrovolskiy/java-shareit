...
public class BookingControllerTest {
    ...
    BookingRequestDto inputBookingDto = BookingRequestDto.builder()
            .start(LocalDateTime.of(2222, 12, 12, 12, 12, 12))
            .end(LocalDateTime.of(2223, 12, 12, 12, 12, 12))
            .itemId(1L).build();
    BookingRequestDto invalidInputBookingDtoWithWrongStart = BookingRequestDto.builder()
            .start(LocalDateTime.of(1111, 12, 12, 12, 12, 12))
            .end(LocalDateTime.of(2223, 12, 12, 12, 12, 12))
            .itemId(1L).build();
    BookingResponseDto outputBookingDto = BookingMapper.toOutputDto(booking);
